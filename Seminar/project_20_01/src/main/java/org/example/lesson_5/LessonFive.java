...
public class LessonFive {
    ...
    public static void main() {
        ...
        try {
            System.out.println("Введите startX начала ");
            startX = scan.nextInt();
            System.out.println("Введите startY начала ");
            startY = scan.nextInt();
            System.out.println("Введите startX конца ");
            exitX = scan.nextInt();
            System.out.println("Введите startY конца ");
            next_y = scan.nextInt();
        } catch (InputMismatchException e) {
            System.out.println(red + "Неверный ввод! " + reset);
        }

        findPath(startX, startY, exitX, next_y);
        traceOut();
        System.out.println();
    }
}